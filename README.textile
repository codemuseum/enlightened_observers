...
This plugin makes the observers that they're used with non-functional when the models they observe are updated in any way other than through controllers (e.g. script/console).  

We're currently investigating how to get around this.
